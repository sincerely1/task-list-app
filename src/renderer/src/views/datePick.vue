    ...
    <div style=" padding: 30px;">
        <div class="datePickView">
            <div class="pickHeader-firts">
                <div>日期</div>
                <el-switch size="large" v-model="useDate" @change="openDate" />
            </div>
            ...
            <div class="pickHeader">
                <div>时间</div>
                <el-switch size="large" v-model="useTime" @change="openTime" />
            </div>
            <div class="timePick">
                <el-time-picker :disabled="!useTime" size="large" format="HH:mm" v-model="SelectTime" placeholder="输入时间" />
            </div>
            <div class="pickHeader">
                <div>重复</div>
                <el-select v-model="Repeatvalue" class="m-2" placeholder="Select" size="large" :disabled="!useDate" >
